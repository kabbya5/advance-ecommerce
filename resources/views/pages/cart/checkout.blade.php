                                    ...
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600">
                                                <th scope="row" class="px-6 py-4 text-lg font-semibold text-gray-900">
                                                    <a href="{{ route('product.show',$cart->name) }}"> {{ $cart->name }}</a>
                                                </th>
                                                <td class="px-6 py-4 text-lg font-semibold">
                                                    {{ $cart->price }} TK
                                                </td>
                                                <td class="px-6 py-4 text-lg font-semibold f">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" align="right"> 
                                                 ...
                                                 <td colspan="1"> 
                                                     <span class="text-red-500 text-lg font-semibold pl-5 ">{{ Session::get('coupon')['finalAmount'] }} TK</span>
                                                 </td>
                                                @else
                                                <td colspan="2" align="right"> 
                                                    <span class=" text-black text-lg font-semibold">
                                                 ...
                                                 <td colspan="1"> 
                                                     <span class="text-red-500 text-lg font-semibold pl-5 ">{{ (int)str_replace(',', '', Cart::Subtotal())}} TK</span>
                                                 </td>
                                                @endif
                                            </tr>
                                            <tr>
                                                <td colspan="2" align="right"> 
                                                 ...
                                                 <td colspan="1"> 
                                                     <span class="text-red-500 text-lg font-semibold pl-5 ">{{ Session::get('charge')['charge'] }} TK</span>
                                                 </td>  
                                            </tr>
                                            <tr>
                                                @if (Session::has('coupon'))
                                                <td colspan="2" align="right"> 
                                                 ...
                                                 <td colspan="1"> 
                                                     <span class="text-red-500 text-lg font-semibold pl-5 ">{{ Session::get('coupon')['finalAmount'] + Session::get('charge')['charge']}} TK</span>
                                                 </td>
                                                @else
                                                <td colspan="2" align="right"> 
                                                    <span class="text-black text-lg font-semibold">
                                                 ...
                                                 <td colspan="1"> 
                                                     <span class="text-red-500 text-lg font-semibold pl-5">{{(int)str_replace(',', '', Cart::Subtotal()) + Session::get('charge')['charge']}}  TK</span>
                                                 </td>
                                                @endif
                                            </tr>    
                                        </tbody>        
