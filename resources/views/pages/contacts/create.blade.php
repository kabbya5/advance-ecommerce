                            ...
                            @csrf
                                <div class="form-group">
                                    ...
                                    @error('phone')
                                        <p class="text-red-500">{{ $message }}</p>
                                    @enderror
                                    <input type="text" name="subject" value="{{ old('name') }}"class="w-full  mb-3 @error('subject') border-2 border-red-500 @enderror" placeholder="Full Name" required>
                                    @error('subject')
                                        <p class="text-red-500">{{ $message }}</p>
                                    @enderror           
                                    
                                    <label for="message" class="text-left block">Enter Your Message</label>
                                    <textarea name="message" placeholder="" id="" cols="30" rows="5" class="w-full">
                                    </textarea>
                                </div>
