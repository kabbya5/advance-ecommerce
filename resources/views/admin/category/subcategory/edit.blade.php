        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
            ...
            <div class="mb-4">
                ...
                <input class=" @error('subcat_name') border border-red-500 @enderror shadow appearance-none border rounded 
                    ...
                    id="subcat_name" name="subcat_name"  value="{{ old('subcat_name',$subcategory->subcat_name) }}" type="text">
                @error('subcat_name')
            ...
            <div class="mb-4">
                ...
                <select class="w-full @error('category_id') border border-red-500 @enderror" name="category_id" id="category_id">
                    <option class="text-slate-500" {{$subcategory->category->id }}> {{ $subcategory->category->cat_name }} </option>
