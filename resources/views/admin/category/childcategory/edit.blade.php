...
<div class="mt-8">
    <div class="w-full md:w-2/3 lg:w-1/2 xl:2/5 mx-auto">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
            action="{{ route('childcategories.update', $childcategory->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-4">
                ...
                <input class=" @error('childcat_name') border border-red-500 @enderror shadow appearance-none border rounded 
                    ...
                    id="childcat_name" name="childcat_name" value="{{ old('childcat_name',$childcategory->childcat_name) }}" type="text" placeholder="childcategory Name ">
                @error('childcat_name')
            ...
            <div class="mb-4">
                ...
                <select class="w-full @error('subcategory_id') border border-red-500 @enderror" name="subcategory_id" id="subcategory_id">
                    <option class="text-slate-500" value="{{ $childcategory->subcategory->id }}"> {{ $childcategory->subcategory->subcat_name }} </option>
            ...
            <button class=" px-4 py-2 bg-blue-800 text-white trangition duration-300 hover:text-slate-500 hover:bg-white"> Update Category  </button>
        </form>
    </div>
    <div class="flex justify-around bg-white pt-3 md:pt-8 border ">
        <div class="">
