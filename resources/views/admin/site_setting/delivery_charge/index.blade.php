...
@section('content')
    <div class="flex py-5 xl:py-0 my-10 xl:my-0 xl:bg-white">
        <div class="my-auto mx-auto bg-white sm:px-8 py-8 xl:p-0 rounded-md shadow-md w-full sm:w-3/4">
            <h2 class="font-bold text-2xl xl:text-3xl text-center">  Delivery System  <a href="{{ route('delivery_charge.create') }}" class="text-blue-800"> Create New </a> </h2>
            <div class="mt-8">
                <table class="table-auto w-full">
                    ...
                    <tbody class="mt-5">
                        ...
                        <tr>
                            ...
                            <a class="mr-3 text-red-800 delete-confirm" href="{{ route('delivery_charge.destory',$charge->id) }}">
