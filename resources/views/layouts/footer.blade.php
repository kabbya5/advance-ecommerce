    ...
    <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
        <div>
            ...
            <ul class="text-gray-300">
                <li class="mb-4">
                    <a href="{{ route('contacts.create') }}" class=" hover:underline"> Contact Us </a>
                </li>
                <li class="mb-4">
                    <a href="{{ route('terms') }}" class="hover:underline">Terms And Condition </a>
                </li>
                <li class="mb-4">
                    <a href="{{ route('privacy') }}" class="hover:underline"> Privacy And Policy </a>
                </li>
                <li class="mb-4">
                    <a href="{{ route('return.policy') }}" class="hover:underline"> Return Policy </a>
                </li>
            </ul>
        </div>
        <div>
